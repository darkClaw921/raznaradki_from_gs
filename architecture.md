...
### Функции webhook
- **extractWebhookInfo** - извлечение типа действия и данных из webhook, включая platform_tax
- **deleteBookingFromSheet** - удаление бронирования и сдвиг строк вверх
- **addBookingToSheet** - добавление/обновление бронирования в таблицу с автоматическим расчетом колонок G и H
...
### Расчет колонок в webhook
- **Колонка G (общая сумма)**: totalAmount - platform_tax, округление до целого
- **Колонка H (предоплата)**: prepayment - platform_tax, округление до целого
- **platform_tax**: извлекается из webhook данных, при отсутствии или null используется 0
