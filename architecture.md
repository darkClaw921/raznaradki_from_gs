...
- **controllers/**: Обработчики HTTP запросов
  ...
  - systemController.ts - Системные настройки
- **models/**: Модели данных для Sequelize ORM
  ...
  - SystemSettings.ts - Системные настройки
  - Group.ts - модель групп
  - Report.ts - модель отчетов по таблицам
- **routes/**: API маршруты
  ...
  - systemRoutes.ts - Системные маршруты
