...
### 9. **✅ СИСТЕМА WEBHOOK ДЛЯ АВТОМАТИЧЕСКОГО ДОБАВЛЕНИЯ ДАННЫХ БРОНИРОВАНИЯ (30.01.2025):**
...
- **✅ Автоматическое маппинг данных:**
  - Дата заселения → Столбец 0
  - Кол-во дней (автоматический расчет) → Столбец 1
  - Дата выселения → Столбец 2
  - ФИО гостя → Столбец 3
  - Телефон → Столбец 4
  - Общая сумма → Столбец 5
  - Предоплата → Столбец 6
  - Доплата за день → Столбец 7
  - Статус дома → Столбец 8
  - Источник → Столбец 9
  - Комментарий → Столбец 10
