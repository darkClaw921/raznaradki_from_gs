...
JSON_OBJECT(
    ...
    'sampleData', JSON_ARRAY(
        ...
        JSON_OBJECT('row', 1, 'column', 5, 'value', '952 894-02-91'),
        ...
        JSON_OBJECT('row', 3, 'column', 5, 'value', '999 833-04-75'),
        ...
        JSON_OBJECT('row', 5, 'column', 5, 'value', '905 745-64-99'),
        ...
        JSON_OBJECT('row', 6, 'column', 5, 'value', '985 915-77-55'),
        ...
        JSON_OBJECT('row', 8, 'column', 5, 'value', '980 489-80-00'),
...
JSON_OBJECT(
    ...
    'sampleData', JSON_ARRAY(
        ...
        JSON_OBJECT('row', 2, 'column', 3, 'value', '916 747 52 19'),
        ...
        JSON_OBJECT('row', 2, 'column', 7, 'value', '986 990 79 17'),
